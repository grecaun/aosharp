...
namespace AOSharp.Core
{
    public static class Network
    {
        ...
        private static Dictionary<N3MessageType, Action<N3Message>> n3MsgCallbacks = new Dictionary<N3MessageType, Action<N3Message>>
        {
            ...
            { N3MessageType.GridDestinationSelect, OnGridDestinationSelect },
        ...
        */
        ...
        private static void OnGridDestinationSelect(N3Message n3Msg)
        {
            GridDestination.OnGridDestinationSelectMessage((GridDestinationSelectMessage)n3Msg);
        }

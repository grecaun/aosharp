...
namespace AOSharp.Core
{
    public static class Targeting
    {
        ...
        public static bool TryGetTarget(out Dynel target)
        {
            target = null;
            ...
            return DynelManager.Find(targetIdentity, out target);
        }

        public static bool TryGetTargetChar(out SimpleChar target)
        {
            target = null;
            Identity targetIdentity = GetTargetIdentity();

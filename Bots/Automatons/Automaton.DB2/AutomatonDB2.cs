...
using AutomatonDB2.IPCMessages;
...
{
    public class AutomatonDB2 : AOPluginEntry
    {
        public const string PluginName = "AutomatonDB2";
        ...
        public static readonly FellState Fell = new FellState();
        public static readonly FightState Fight = new FightState();
        public static readonly FightTowerState FightTower = new FightTowerState();
        public static readonly IdleState Idle = new IdleState();
        public static readonly NotumState Notum = new NotumState();
        public static readonly PathToBossState PathToBoss = new PathToBossState();

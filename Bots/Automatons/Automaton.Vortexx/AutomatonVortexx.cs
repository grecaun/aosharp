...
{
    public class AutomatonVortexx : AOPluginEntry
    {
        public const string PluginName = "AutomatonVortexx";
        ...
        public static readonly ImmunityState Immunity = new ImmunityState();
        ...
        public static class Nanos
        {
            ...
            public const int CleansingBreath = 280800;

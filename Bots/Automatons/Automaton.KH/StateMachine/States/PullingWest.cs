...
namespace AutomatonKiteHill
{
    public class PullWest : IState
    {
        ...
        {
            AutomatonKiteHill.PullStartIndex = 24;
            AutomatonKiteHill.vectorList = Constants.KHWestVectorList;
            AutomatonKiteHill._counterVec = 0;
            _castedMongo = false;
            _LastCastTimeStamp = 0;

            Chat.WriteLine("Pulling West");
        }
        ...
        public IState GetNextState()
        {
            ...
            switch (DynelManager.LocalPlayer.Profession)
            {
                ...
                case Profession.Enforcer:
                    ...
                    {
                        AutomatonKiteHill.IPCChannel.Broadcast(new MoveWestMessage());
                        return AutomatonKiteHill.Nuke_State;
                    }
                    break;
            }

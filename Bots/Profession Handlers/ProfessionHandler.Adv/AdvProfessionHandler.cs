...
namespace ProfessionHandler.Adventurer
{
    public class AdvProfessionHandler : GenericProfessionHandler
    {
        private readonly string PluginDirectory;

       
        public AdvProfessionHandler(string pluginDir) : base(pluginDir)
        {
            try
            {
                ...
                Chat.WriteLine("Adventurer Profession Handler Loaded!");
        ...
        private void HandlerCommand(string arg1, string[] arg2, ChatWindow window)
        {
            try
            {
                ...
                _mainWindow = Window.CreateFromXml("PH Advy", PluginDirectory + "\\UI\\AdvSettingsView.xml", windowStyle: WindowStyle.Default, windowFlags: WindowFlags.AutoScale | WindowFlags.NoFade);

...
{
    public class NTProfessionHandler : GenericProfessionHandler
    {
        private readonly string PluginDirectory;

        public NTProfessionHandler(string pluginDir) : base(pluginDir)
        {
            try
            {
                ...
                Chat.WriteLine("NT Profession Handler Loaded!");
        ...
        private void HandlerCommand(string arg1, string[] arg2, ChatWindow window)
        {
            ...
            _mainWindow = Window.CreateFromXml("PH NT", PluginDirectory + "\\UI\\NTSettingsView.xml", windowStyle: WindowStyle.Default, windowFlags: WindowFlags.AutoScale | WindowFlags.NoFade);

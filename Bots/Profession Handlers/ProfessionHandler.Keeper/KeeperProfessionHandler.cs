...
{
    public class KeeperProfessionHandler : GenericProfessionHandler
    {
        private readonly string PluginDirectory;

        public KeeperProfessionHandler(string pluginDir) : base(pluginDir)
        {
            try
            {
                ...
                Chat.WriteLine("Keeper Profession Handler Loaded!");
        ...
        private void HandlerCommand(string arg1, string[] arg2, ChatWindow window)
        {
            ...
            _mainWindow = Window.CreateFromXml("PH Keeper", PluginDirectory + "\\UI\\KeeperSettingsView.xml", windowStyle: WindowStyle.Default, windowFlags: WindowFlags.AutoScale | WindowFlags.NoFade);
